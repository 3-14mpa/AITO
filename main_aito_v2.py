...
from shared_components import ATOM_DATA, PROMPTS, message_to_document, chunk_text, search_memory_tool, search_knowledge_base_tool, list_uploaded_files_tool, set_registry_value, get_registry_value, list_registry_keys, generate_diagram_tool, read_full_document_tool, display_image_tool
...
def get_ai_response(user_message: HumanMessage, chain_for_request, atom_id_for_request: str, tool_registry: dict):
    try:
        ...
        while response.tool_calls:
            ...
            for tool_call in response.tool_calls:
                ...
                if isinstance(tool_output, str) and tool_output.startswith("UI_COMMAND:DISPLAY_IMAGE:"):
                    ...
                    add_image_bubble_to_chat(image_path.strip())
                    ...
                    add_image_bubble_to_chat(image_path)
        ...
        update_ui_with_ai_message(final_response)
        ...
        update_ui_with_ai_message(error_message)
    ...
    def send_click(e):
        ...
        get_ai_response(human_message, app_state["atom_chain"], app_state["active_atom_id"], app_state["tool_registry"])
    ...
    # page.update()
    logging.info("A main függvény véget ért.")
